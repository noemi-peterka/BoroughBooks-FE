...
```
GET /api/users/:username/my-library
```

### Get books a user has borrowed

```
GET /api/users/:username/borrowed
```

### Get books a user has loaned

```
GET /api/users/:username/loaned
```
...
For full endpoint documentation, see the backend repository.
